...
from .composite_batch import CompositeBatchRewardManager


def get_reward_manager(name: str):
    """
    Backwards-compatible alias for registries that expect get_reward_manager.
    Returns the reward manager class registered under the given name.
    """
    return get_reward_manager_cls(name)


# Note(haibin.lin): no need to include all reward managers here in case of complicated dependencies
__all__ = [
    "BatchRewardManager",
    "CompositeBatchRewardManager",
    "DAPORewardManager",
    "NaiveRewardManager",
    "PrimeRewardManager",
    "register",
